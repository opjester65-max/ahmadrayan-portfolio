...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(20, 20, 25, 0.95) 0%, rgba(16, 185, 129, 0.05) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(16, 185, 129, 0.25)',
            ...
            <div className="pc-content pc-avatar-content">
              ...
              {showUserInfo && (
                <div className="pc-user-info">
                  ...
                  <button
                    className="pc-contact-btn animate-pulse"
